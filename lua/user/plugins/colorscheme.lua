return {
	...
	-- 	vim.api.nvim_set_hl(0, "@type", { fg = func }) -- Modify type color
	-- 	vim.api.nvim_set_hl(0, "@type.builtin", { fg = func })
	-- 	vim.api.nvim_set_hl(0, "@function.builtin", { fg = "NONE", bold = false, italic = false })
	-- 	-- vim.api.nvim_set_hl(0, "@function.builtin", { fg = func, bold = false, italic = false })
	-- 	-- vim.api.nvim_set_hl(0, "@function.builtin", { fg = func, bold = false, italic = false })
	-- 	-- vim.api.nvim_set_hl(0, "Keyword", { fg = "NONE", bold = false, italic = false })
	-- 	-- vim.api.nvim_set_hl(0, "@keyword", { bg = "NONE" }) -- For general keywords
	-- 	-- vim.api.nvim_set_hl(0, "@function.builtin", { bg = "NONE" })
	-- end,
	"p00f/alabaster.nvim",
	config = function()
		-- 	-- require("sonokai").setup({
